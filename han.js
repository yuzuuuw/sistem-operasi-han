...
const data = materi[currentMateri];

document.getElementById("materiNumber").textContent =
data.nomor;

document.getElementById("materiTitle").textContent =
data.judul;

document.getElementById("materiText").textContent =
data.isi;

document.getElementById("materiVisual").innerHTML =
data.visual;

document.getElementById("materiHighlight").innerHTML =
data.poin.map(item =>
...
document
.getElementById("teacherCharacter")
.addEventListener("click", () => {

currentMateri++;

if(currentMateri >= materi.length){
currentMateri = 0;
}
...
const materi = [
{
  nomor: "01",
  judul: "Apa itu RAM?",
  isi: "RAM bisa diibaratkan seperti meja belajar. Semua buku yang sedang digunakan diletakkan di atas meja agar mudah dijangkau.",

  visual: `
    <div class="visual-box active">
      🧠
      <span>RAM</span>
    </div>
  `,
...
{
  nomor: "02",
  judul: "Peran Sistem Operasi",
  isi: "Sistem operasi seperti pengatur meja belajar yang menentukan buku mana yang boleh digunakan dan kapan harus dirapikan.",

  visual: `
    <div class="visual-box">💾<span>Hard Disk</span></div>
    <div class="visual-arrow">→</div>
    <div class="visual-box active">🧠<span>RAM</span></div>
    <div class="visual-arrow">→</div>
    <div class="visual-box">⚡<span>CPU</span></div>
  `,

  poin: [
    "📦 Membagi RAM",
    "🧹 Membersihkan memori",
    "⚖️ Mengatur prioritas"
  ]
},

{
  nomor: "03",
  judul: "Program dan RAM",
  isi: "Sebelum digunakan, program harus dipindahkan dari lemari penyimpanan ke meja belajar agar bisa diakses dengan cepat.",

  visual: `
    <div class="visual-box">📄<span>Program</span></div>
    <div class="visual-arrow">→</div>
    <div class="visual-box active">🧠<span>RAM</span></div>
    <div class="visual-arrow">→</div>
    <div class="visual-box">💾<span>Virtual Memory</span></div>
  `,

  poin: [
    "📥 Program masuk RAM",
    "🚀 CPU mengambil data",
    "💾 RAM penuh → Virtual Memory"
  ]
},

{
  nomor: "04",
  judul: "Sistem Penyimpanan Disk",
  isi: "Disk seperti lemari penyimpanan yang menyimpan semua data dan program meskipun komputer sedang dimatikan.",

  visual: `
    <div class="visual-box">📄<span>File</span></div>
    <div class="visual-arrow">→</div>
    <div class="visual-box active">💾<span>Disk</span></div>
    <div class="visual-arrow">→</div>
    <div class="visual-box">🗄️<span>Penyimpanan</span></div>
  `,

  poin: [
    "💾 Menyimpan data permanen",
    "📂 Kapasitas lebih besar dari RAM",
    "🔌 Data tetap ada saat komputer mati"
  ]
}
